...
export const ChatBubbleLeftRightIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72.372a3.527 3.527 0 0 1-3.296-2.043l-1.148-2.297c-.174-.346-.295-.718-.363-1.103a2.25 2.25 0 0 1 .39-1.573l1.148-2.297c.54-1.079 1.664-1.78 2.87-1.78h1.244A2.25 2.25 0 0 0 20.25 8.511Zm-6.556 4.163c.225.025.45.042.676.042a4.482 4.482 0 0 0 4.205-2.924c.23-.62.273-1.282.118-1.916a2.25 2.25 0 0 0-2.023-1.625l-2.023-.337c-1.123-.187-2.194.274-2.87 1.148l-1.148 2.297a2.25 2.25 0 0 0 .39 1.573Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.375c.621 0 1.125.504 1.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125H3.75v-3.75Zm0 0h1.5M4.5 9.75v1.5c0 .621.504 1.125 1.125 1.125h1.5c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125h-1.5A1.125 1.125 0 0 0 4.5 9.75Z" />
  </svg>
);
...
export const BrainCircuitIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 13.5h-1.875a1.875 1.875 0 1 0-3.75 0H9.167a4.5 4.5 0 0 1-1.416-.292V10.5h1.416a1.875 1.875 0 1 0-3.75 0H5.25v2.25a7.5 7.5 0 0 0 5.25-2.134 7.5 7.5 0 0 0 5.25 2.134h.001Z" />
  </svg>
);
